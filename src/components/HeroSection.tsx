  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center relative px-6 overflow-hidden pb-12">
      ...
      <div className="text-center relative z-10 pt-24 md:pt-20">
        ...
        >
          <div className="glitch-text" data-text="Erik">
            Erik
          </div>
          <br />
          <div className="glitch-text" data-text="Millier.">
            <span className="text-foreground/20">Millier.</span>
          </div>
        </h1>
        ...
        <div className="mt-10">
          <Magnetic strength={0.1}>
            <a
              href="/resume.pdf"
              download="Erik_Millier_Montolio_Resume.pdf"
              onClick={playClick}
